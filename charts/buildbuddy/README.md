...
| `image.tag`                          | Container image tag                                                                                                                                                                                                                                                                                                         | `v2.11.14`                                                                                                                  |
...
| `statefulset.storageClass`           | Statefulset PVC Storage Class                                                                                                                                                                                                                                                                                                 | `nil`                                                                                                            |
| `statefulset.size`                   | Statefulset PVC Size                                                                                                                                                                                                                                                                                                 | `nil`                                                                                                            |
| `statefulset.ingressPerReplica`      | Whether or not to create a Service and Ingress for each replica in the Statefulset                                                                                                                                                                                                                                                                                                 | `nil`                                                                                                            |
| `statefulset.ports`                  | Statefulset Ports                                                                                                                                                                                                                                                                                                 | `nil`                                                                                                            |

Specify each parameter using the `--set key=value[,key=value]` argument to `helm install`. For example,

```bash
$ helm install my-release \
  --set image.tag=v2.11.14\
  --set mysql.mysqlUser=sampleUser \
  --set mysql.mysqlPassword=samplePassword \
