...
| `image.tag`                          | Container image tag                                                                                                                                                                                                                                                                                                         | `v2.207.0`                                                                                                                  |
...
| `ingress.grpc.disableDefaultAnnotations` | If `true`, disables the default nginx annotations for grpc (backend-protocol and configuration-snippet)                                                                                                                                                                                                                     | `false`                                                                                                                   |
