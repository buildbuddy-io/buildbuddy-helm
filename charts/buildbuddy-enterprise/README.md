...
| `image.tag`                          | Container image tag                                                                                                                                                                                                                                                                                                         | `enterprise-v2.288.0`                                                                                                     |
...
| `distributed.schedulerRPCScheme`     | Scheduler RPC scheme app replicas use when dialing peer schedulers through the headless StatefulSet DNS name. Set to `grpcs` to use the GRPCS listener. Requires a BuildBuddy image with [buildbuddy-io/buildbuddy#12574](https://github.com/buildbuddy-io/buildbuddy/pull/12574) and trusted TLS certs for the pod or headless DNS names. | `grpc`                                                                                                                               |
...
$ helm install my-release \
  --set image.tag=enterprise-v2.288.0 \
  --set mysql.mysqlUser=sampleUser \
  --set mysql.mysqlPassword=samplePassword \
